...
<html lang="en">
    ...
    <body id="page-top">
                ...
                <div class="col">
                  <div class="card text-center">
                    <div class="card-body">
                      ...
                      <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal" data-id="1">Primary</button>
                    </div>
                  </div>
                </div>
                <div class="soal-col">
        ...
        $('.btn-primary').click(function() {
            ...
            var value = $(this).closest('.card-body').find('.card-text').text();
            $('#judulInput').val(title);
            $('#nilaiInput').val(value);
            $('#saveChangesButton').data('id', id);
            $('#myModal').modal('show');
        });

        $('#saveChangesButton').click(function() {
            var id = $(this).data('id');
            var newTitle = $('#judulInput').val();
            var newValue = $('#nilaiInput').val();
            // Lakukan sesuatu dengan data yang disimpan (misalnya, AJAX request).
